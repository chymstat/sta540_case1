...
|&nbsp;&nbsp;In the past 6 months took PrEP                                  |22 (8.7)   |
|&nbsp;&nbsp;Never took PrEP                                                 |232 (91.3) |
...
|&nbsp;&nbsp;Never                                                           |36 (14.2)  |
|&nbsp;&nbsp;Sometimes                                                       |108 (42.5) |
|Condomless receptive anal sex in the past 90 days                           |210 (82.7) |
...
Besides, we tested contrasts stated in appendeix A across waves.Suppose the rates for platforms are expressed using $\lambda_{wave,platform}$, the null hypotheses are $H_{01}:\lambda_{1,Facebook}=\lambda_{1,Grindr}\ and\ \lambda_{2,Instagram}=\lambda_{2,Jack'd}$; $H_{02}:\lambda_{1,Facebook}=\lambda_{1,Google}\ and\ \lambda_{2,Instagram}=\lambda_{2,Bing}$; $H_{03}:\lambda_{1,Grindr}=\lambda_{1,Google}\ and\ \lambda_{2,Jack'd}=\lambda_{2,Bing}$. Result shows there was statistically significant difference across the waves. Likelihhod ratio tests give p-values all less than 0.01.
...
|---------------------------|------------|------|------------------------------|-----------------------------|------------------------------------|
| **Social media site**     | Facebook   | 1   | 70                           | 13                          | 0.19                               |
|                           | Instagram  | 2    | 38                           | 13                          | 0.34                               |
|                           | **Subtotal** | N/A  | 108                          | 26                          | 0.24                               |
| **Dating app**            | Grindr     | 1   | 70                           | 9                           | 0.13                               |
|                           | Jack'd     | 2    | 38                           | 125                         | 3.29                               |
|                           | **Subtotal** | N/A  | 108                          | 134                         | 1.24                               |
| **Information search site** | Google     | 1   | 70                           | 17                          | 0.24                               |
|                           | Bing       | 2    | 38                           | 0                           | 0.00                               |
